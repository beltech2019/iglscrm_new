                    ...
                    <div class="tabscircle2">
                        <div class="tab-content mt-2 mx-1" id="myTabContent">
                            <div class="tab-pane fade show active" id="lead" role="tabpanel" aria-labelledby="lead-tab">
                                <form action="/getadminupdatebyReport" method="GET">
                                @csrf
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" placeholder="Source" name="adminuser" id="searchSelect">
                                ...
                                <div class="my-2 row">
                                            ...
                                            <div class="col-md-3">
                                                <p style="margin-top: 8px;text-align: right;" class="pagination-info">
                                                    Showing {{ $getInfo->firstItem() }} - {{ $getInfo->lastItem() }} of {{ $getInfo->total() }} admin update
                                                </p>
                                            </div>
                                        </div>
                                <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($getInfo as $info)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{
                                                                $info->table_name == "tb_rule_priority" ?
