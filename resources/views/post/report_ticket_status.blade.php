            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    <div class="heading_two ">
                        <h2><i class="bi bi-ticket iconsbg2"></i>Ticket By Status and Date</h2>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="iconsmenu">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="coulams_form">
                                ...
                                <p class="peragraph_content">Ticket By Status and Date</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="coulams_form">
                                <label class="form-label">Date Created </label>
                                <p class="peragraph_content">01-02-2023, <span class="byname">By devnaru </span></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="coulams_form">
                        ...
                        <div class="col-md-6">
                            <div class="coulams_form">
                                ...
                                <p class="peragraph_content">Null</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="coulams_form">
