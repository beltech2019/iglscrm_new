                    ...
                    <div class="tabscircle2">
                        ...
                        <div class="tab-content mt-2 mx-1" id="myTabContent">
                            <div class="tab-pane fade show active" id="lead" role="tabpanel" aria-labelledby="lead-tab">
                                ...
                                <form action="/getLeadsReport" method="GET">
                                @csrf
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                ...
                                <div class="my-2 row">
                                            ...
                                            <div class="col-md-3">
                                                <p style="margin-top: 8px;text-align: right;" class="pagination-info">
                                                    Showing {{ $getInfo->firstItem() }} - {{ $getInfo->lastItem() }} of {{ $getInfo->total() }} lead
                                                </p>
                                            </div>
                                        </div>
                                <div class="row">
                                        ...
                                        <div class="pb-1">
                                            <table class="table tickettable">
                                                ...
                                                @foreach ($getInfo as $info)
                                                    <tr>
                                                        <td scope="row">{{ $info->created_date }}</td>
                                                        <td>{{ $info->leadId }}</td>
                                                        <td>{{ $info->description }}</td>
                                                        <td>{{ $info->first_name }} {{ $info->last_name }}</td>
                                                        <td>{{ $info->lead_source }}</td>
                                                        <td>{{ $info->leadBy }}</td>
                                                        <td>{{ $info->status }}</td>
                                                    </tr>
                                                @endforeach
